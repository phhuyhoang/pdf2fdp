...
const local = {
  builder: {
    PDFConv: require(`../core/DocumentConverter/builder/converters/PDFConverterBuilder`),
    PDF2PPM: require(`../core/DocumentConverter/builder/converters/PDF2PPM_Builder`),
    PDF2SVG: require(`../core/DocumentConverter/builder/converters/PDF2SVG_Builder`),
    PDFTK: require(`../core/DocumentConverter/builder/splitters/PDFTK_Builder`),
  },
  convert: {
    ConvertEngine: require(`../core/DocumentConverter/ConvertEngine`),
    ConvertConfigurator: require(`../core/DocumentConverter/ConvertConfigurator`),
  },
  util: {
    PDFInfo: require(`../core/DocumentConverter/util/info`),
  },
  prepared: {
    node4prof: {
...
// ava.after('optional: remove all downloaded & converted files', function removeAllConvertedFiles(test) {
//   try {
//     syslib.fs.safeRecursiveRemove(`${__dirname}/convert/`);
//     syslib.fs.mkdirSync(`${__dirname}/convert`);
//   }
//   catch (error) {
